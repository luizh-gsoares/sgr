                ...
                <form action="gerenciarPerfil" method="POST" accept-charset="iso-8859-1,utf-8">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="idNome" name="nome" value="${perfil.nome}">
                        </div>
                        <div class="form-group">
                            <label for="iddata">Data de Cadastro :</label>
                            <input type="date" class="form-control" id="idData" name="dataCadastro"
                                value="${perfil.data}">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="submit" class="btn btn-success toastsDefaultInfo">Gravar&nbsp;</button>
                    </div>
                </form>
                <!-- /.form-end -->
            </div>
