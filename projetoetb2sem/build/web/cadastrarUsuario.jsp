                ...
                <% String msg=(String) request.getAttribute("msg"); if(msg !=null){
                    ...
                    <div id="container">
                        ...
                        <div id="conteudo" class="bg-background">
                            <form action="gerenciarUsuario" method="POST" accept-charset="iso-8859-1,utf-8">
                                ...
                                <div class="form-group row offset-md-3 mt-4">
                                    <label for="idnome" class="col-md-1 form-label btn btn-primary btn-md">Nome</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row offset-md-3 mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="login" id="idlogin" class="form-control"
                                            value="${usuario.login}">
                                ...
                                <div class="form-group row offset-md-3 mt-4">
                                    ...
                                    <div class="col-md-6">
                                        <input type="secret" name="senha" id="idsenha" class="form-control"
                                            value="${usuario.senha}">
                                ...
                                <div class="form-group row offset-md-3 mt-3">
                                    <label for="idstatus"
                                        class="col-md-1 form-label btn btn-primary btn-md mt-2">Status</label>
                                    <div class="col-md-6">
                                        <select id="idstatus" name="status" class="form-control-sm mt-2">
                                ...
                                <div class="form-group row offset-md-3 mt-3">
                                    <label for="idperfil" class="col-md-1 form-label btn btn-primary btn-md mt-2">
                                        Perfil
                                    </label>
                                    <div class="col-md-6">
                                        <select id="idperfil" name="idPerfil" class="form-control mt-2">
                                            <jsp:useBean class="model.PerfilDAO" id="pdao" />
                                            <c:forEach var="p" items="${pdao.lista}">
                                                <option value="${p.idPerfil}" <c:if
                                                    test="${p.idPerfil == usuario.perfil.idPerfil}">
                                                    selected
                                                    </c:if>>
                                                    ${p.nome}
                                                </option>
                                ...
                                <div class="d-md-flex justify-content-md-end mr-3">
                                    ...
                                    <a href="gerenciarUsuario?acao=listar" class="btn btn-warning btn-md" role="button">
